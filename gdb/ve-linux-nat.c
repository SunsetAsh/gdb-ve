  ...
  if (have_ptrace_getregset == TRIBOOL_TRUE)
    {
      ...
      ret = ptrace_func (PTRACE_GETREGSET, tid, (void *)NT_FPREGSET, &iov);
    }
  else
  ...
  if (have_ptrace_getregset == TRIBOOL_TRUE)
    {
      ...
      ret = ptrace_func (PTRACE_SETREGSET, tid, (void *)NT_FPREGSET, &iov);
    }
  else
  ...
  if (have_ptrace_getregset == TRIBOOL_TRUE)
    {
      ...
      ret = ptrace_func (PTRACE_GETREGSET, tid, (void *)NT_PRSTATUS, &iov);
    }
  else
  ...
  if (have_ptrace_getregset == TRIBOOL_TRUE)
    {
      ...
      ret = ptrace_func (PTRACE_SETREGSET, tid, (void *)NT_PRSTATUS, &iov);
    }
  else
  ...
  if (have_ptrace_getregset == TRIBOOL_UNKNOWN)
    {
      ...
      if (ptrace_func (PTRACE_GETREGSET, tid, (void *)NT_PRSTATUS, &iov) < 0)
...
long (*ptrace_func) (int, int, void *, void *);
extern "C" {
